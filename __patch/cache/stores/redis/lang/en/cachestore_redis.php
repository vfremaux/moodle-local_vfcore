...
$string['dbid'] = 'DB Id';
$string['dbid_help'] = 'Selects one of available database instance in redis. check the /etc/redis/redis.conf databases setting.';
$string['dbidinvalid'] = 'Invalid dbid. Must be integer.';
// CHANGE-.
