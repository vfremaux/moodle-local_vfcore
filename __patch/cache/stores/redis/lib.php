...
class cachestore_redis extends cache_store implements cache_is_key_aware, cache_is_lockable,
    ...
    public function __construct($name, array $configuration = array()) {
        ...
        // CHANGE+ : Add dbid management.
        $dbid = !empty($configuration['dbid']) ? $configuration['dbid'] : 0;
        $this->redis = $this->new_redis($configuration['server'], $prefix, $password, $dbid);
        // CHANGE-.
    }
     ...
     */
    // CHANGE+ : add dbid management.
    protected function new_redis($server, $prefix = '', $password = '', $dbid = 0) {
        // CHANGE-.
        $redis = new Redis();
    ...
    public static function config_set_edit_form_data(moodleform $editform, array $config) {
        ...
        // CHANGE+ : Add dbid management.
        $data['dbid'] = !empty($config['dbid']) ? $config['dbid'] : 0;
        // CHANGE-.
