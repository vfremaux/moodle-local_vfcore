...
require_once($CFG->dirroot.'/local/vfcore/lib.php'); // to get xx_supports_feature();
if ('pro' == local_vfcore_supports_feature()) {
    include($CFG->dirroot.'/local/vfcore/pro/lang/fr/pro.php');
}
